        ...
        <div style={{ backgroundColor: '#1A0A53', color: 'white', padding: '20px' }}>
          ...
          >
            ...
            <div style={{ width: '60%', marginRight: '20px' }}>
              <h2>Immergez-vous au cœur de l'intrigue et résolvez le mystère ! Oserez-vous découvrir les secrets d'une disparition inexplicable dans notre escape game palpitant ? Révélations et énigmes vous attendent...</h2>
              <p style={{ lineHeight: '1.6', margin: '20px 0' }}>
              Vous entrez dans l'univers obscur de mystères et de disparitions. Un proche a disparu dans des circonstances énigmatiques, et vous êtes appelés à explorer les indices laissés derrière lui. Chaque pièce de la salle renferme un
            élément crucial pour résoudre le mystère de sa disparition.

              </p>
    
              
              <p>
              Découvrir la vérité derrière la disparition en reliant les indices disséminés dans la salle, démêler les énigmes temporelles et déverrouiller le chemin vers la révélation
finale. Le temps presse, chaque minute compte. Serezvous capable de percer les secrets de l'Absence et de retrouver votre proche disparu?
              </p>
            </div>
