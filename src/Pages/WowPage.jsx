    ...
    <div style={{ backgroundColor: '#1A0A53', color: 'white', padding: '20px' }}>
      ...
      >
        ...
        <div style={{ width: '60%', marginRight: '20px' }}>
          <h2>Plongez dans l'univers épique de Warcraft et résolvez des énigmes dignes des plus grandes quêtes dans notre escape game captivant à domicile !</h2>
          <p style={{ lineHeight: '1.6', margin: '20px 0' }}>
          Vous êtes recrutés par les forces de l'Alliance et de la Horde pour une mission cruciale dans le monde épique d'Azeroth. Des mystères anciens et des créatures mythiques vous attendent alors que vous vous lancez
            dans une quête pour sauver le royaume en péril.  </p>
          <p>
          Triompher des épreuves des titans, résoudre des énigmes liées aux artefacts légendaires, et combattre les serviteurs des ténèbres. Seul un groupe stratégique et courageux pourra réussir la Quête d'Azeroth
et sauver le monde de World of Warcraft. Êtes-vous prêt à affronter l'aventure?
          </p>
        </div>
        ...
        <div style={{ flexShrink: 0 }}>
          <img
            src="src\assets\wow2.jpg" // Remplacez par le chemin de l'image
            alt="Detective scene"
