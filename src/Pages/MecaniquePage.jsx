    ...
    const navigate = useNavigate();
        ...
        <div style={{ backgroundColor: '#1A0A53', color: 'white', padding: '20px' }}>
          ...
          <section style={{ textAlign: 'center', marginBottom: '50px' }}>
            <img
              src="src\assets\garage1.jfif" 
              alt="L'Atelier des Engrenages"
              style={{ width: '100%', maxHeight: '400px', objectFit: 'cover' }}
            />
            <h1 style={{ position: 'relative', top: '-250px', fontSize: '3em' }}>
            L'Atelier des Engrenages
            </h1>
          </section>
          ...
          >
            ...
            <div style={{ width: '60%', marginRight: '20px' }}>
              <h2>Bienvenue dans le garage des secrets ! Plongé dans l'obscurité et entouré de mystères, saurez-vous découvrir les indices cachés et élucider les énigmes pour sortir avant qu'il ne soit trop tard ?</h2>
              <p style={{ lineHeight: '1.6', margin: '20px 0' }}>
              Vous pénétrez dans un atelier mécanique mystérieux, rempli d'engrenages, de leviers et de machines complexes. Un inventeur renommé a mystérieusement disparu, laissant derrière lui des
énigmes mécaniques et des inventions étranges. Votre mission est de comprendre le fonctionnement de ces mécanismes et de résoudre le mystère qui entoure sa disparition.
              </p>
    
              <p>
              Naviguer à travers des dispositifs mécaniques sophistiqués, résoudre des puzzles basés sur les principes de la mécanique, et dévoiler les secrets cachés de l'atelier. Seule une compréhension approfondie des engrenages et des mécanismes vous permettra de résoudre l'énigme et de découvrir ce qui est arrivé à
l'inventeur. Êtes-vous prêt à relever le défi de l'Atelier des Engrenages?
              </p>
            </div>
